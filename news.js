...
document.addEventListener('DOMContentLoaded', function() {
    generateNews(currentCategory);
});

/*onclick methods for button in html, if clicked we swap categories. Deafult category is general*/
...
/*Use apiKey/url to fetch data/filter for desc, title, and imageURL, and log an error in console if given*/
async function generateNews(category = 'general') {
    
    try {
        const apiKey = 'f29033e5f0ef4bf5bfe55673138e6787';
